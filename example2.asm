...
_start:
  ; int3 ; for debug
  ; initialize rcx to 5
  mov QWORD [counter], 1 ; use dq == dquad memory allocated defined at ending and counter is its address

again:
  cmp QWORD [counter], 20 ; do it 20 times
  jg over ; also lte, gte, here we need greater than.
    mov rdi, QWORD [counter]; put counter in rdi
